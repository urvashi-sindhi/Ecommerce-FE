...
import { viewProduct, editProduct } from "../../Api/productApi";
    ...
    const fetchProduct = async () => {
      ...
      try {
        ...
        setProduct({
          ...
          product_variants: (data.variants || []).map((variant) => ({
            ...
            variant_image: {
              image_path: variant.image?.image_path || "",
            },
          })),
        });
      } catch (err) {
